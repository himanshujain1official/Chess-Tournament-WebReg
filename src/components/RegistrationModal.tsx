            ...
            <div className="text-center font-mono">
              ...
              <div className="rounded-lg p-5 bg-zinc-900 border border-zinc-800 text-left mb-6 text-xs">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  ...
                  <div>
                    <span className="text-zinc-500 block text-[10px] uppercase">Lichess UserName</span>
                    <span className="font-bold text-zinc-300">{generatedPass.playerData.lichessUsername}</span>
                  </div>
                </div>
